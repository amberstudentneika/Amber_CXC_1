...
@section('content')
    ...
    <form class="bg-white p-15 rounded-2xl " method="post" action="{{route('ViewReport')}}">
        @csrf
{{--        <label class="mb-2 block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4 text-center">Select Student</label>--}}
        ...
        <a href="{{url('/view/report/'.$info->id)}}">
            <input type="submit" value="Go" class="shadow bg-green-500 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">
        </a></div>
    </form>
    </div>
@endsection
